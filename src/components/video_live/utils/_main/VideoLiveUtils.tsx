  ...
  return (
    <div
      className={`${_getClassModuleCss('VideoLiveUtils')} ${
        c_time == total_time ? _getClassModuleCss('VideoLiveUtils-live') : ''
      }`}
    >
      <div className={_getClassModuleCss('VideoLiveUtils_row')}>
        ...
        {c_time == total_time && IS_MOBILE ? null : (
          <div
            className={_getClassModuleCss('VideoLiveUtils_live_now')}
        ...
        {IS_MOBILE ? null : (
          <div className={_getClassModuleCss('VideoLiveUtils_part')}>
            <VideoLiveTimeDelay c_time={c_time} total_time={total_time} />
          </div>
        )}
