...
const VideoTimeLineDefaultProps = {
  range: (
    <div className={_getClassModuleCss('VideoTimeLine_range')}>
      <div className={_getClassModuleCss('VideoTimeLine_range_contain')}></div>
    </div>
  ),
  active_range: (
    <div
      ...
      <OneSlider
        range={
          <React.Fragment>
            {range}
            <div
              className={_getClassModuleCss('VideoTimeLine_buffer')}
              style={{ width: `${buffer_time}%` }}
            >
              <div
                className={_getClassModuleCss('VideoTimeLine_buffer_contain')}
              ></div>
            </div>
          </React.Fragment>
        }
